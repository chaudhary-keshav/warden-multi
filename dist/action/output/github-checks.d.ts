 ...
 */
export declare function findingsToAnnotations(findings: Finding[], reportOn?: SeverityThreshold, minConfidence?: ConfidenceThreshold): CheckAnnotation[];
/**
 ...
 */
export declare function determineConclusion(findings: Finding[], failOn?: SeverityThreshold, failCheck?: boolean): CheckConclusion;
/**
