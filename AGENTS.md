...
## CodeTrellis Project Context

> Auto-generated by CodeTrellis (`codetrellis init --ai`). Provides matrix-derived project context.

### ⚠️ Read the Matrix FIRST

Before exploring files manually, **read the full project matrix**:

```bash
cat .codetrellis/cache/warden/matrix.prompt
```
...
codetrellis context . --file src/example.ts
```

### Project Scale

- **Languages:** TypeScript, JavaScript
- **Scale:** 220 files, 70 types, 37 matrix sections
