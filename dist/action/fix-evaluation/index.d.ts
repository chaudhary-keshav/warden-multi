 ...
 */
export declare function evaluateFixAttempts(octokit: Octokit, comments: ExistingComment[], context: EvaluateFixAttemptsContext, currentFindings: Finding[], apiKey: string, maxRetries?: number): Promise<EvaluateFixAttemptsResult>;
